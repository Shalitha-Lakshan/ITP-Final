...
function Footer() {
  return (
    <footer className="bg-green-800 text-white mt-auto py-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-lg font-bold mb-4">EcoRecycle</h3>
            <p className="text-sm text-gray-300">
              Transforming plastic waste into valuable resources through our innovative recycling system.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link to="/bins" className="hover:text-green-300">Smart Bins</Link></li>
              <li><Link to="/products" className="hover:text-green-300">Shop</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              {/* These links assume you have corresponding routes set up in App.js */}
              <li><Link to="/how-it-works" className="hover:text-green-300">How It Works</Link></li>
              <li><Link to="/points-system" className="hover:text-green-300">Points System</Link></li>
              <li><Link to="/manufacturers" className="hover:text-green-300">For Manufacturers</Link></li>
          ...
          <div>
            ...
            <address className="not-italic text-sm text-gray-300">
              ...
              <p className="mt-2">Email: info@ecorecycle.com</p>
        ...
        <div className="border-t border-green-700 mt-8 pt-6 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-4 mt-4 md:mt-0">
            {/* For external social media links, provide a valid URL and use rel="noopener noreferrer" */}
