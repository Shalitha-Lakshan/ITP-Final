...
import { UserCircleIcon, PencilIcon, LockClosedIcon, ArrowRightOnRectangleIcon } from "@heroicons/react/24/outline";
import { useNavigate } from "react-router-dom";

export default function InventoryProfile() {
  const navigate = useNavigate();

  // Mock user profile (replace with backend API call)
